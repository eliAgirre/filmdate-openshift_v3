            ...
            <div id="textoApi">
               ...
               <p>Filmdate proporciona diversas API y herramientas que permiten integrar la experiencia de Filmdate en tu sitio web, aplicación o dispositivo móvil.<br/>
                ...
                <div class="ruta">
                    ...
                    <br/>Por ejemplo: 
                    <a class="apilink" href="../api/api.php/getPeliculas">
                    http://filmdate-filmdate.rhcloud.com/api/api.php/getPeliculas</a>
                    <!--<a class="apilink" href="http://filmdate-filmdate.rhcloud.com/api/api.php/getPeliculas">
                    http://filmdate-filmdate.rhcloud.com/api/api.php/getPeliculas</a>-->
                    </p>
                ...
                <div class="ruta">
                    ...
                    <p>Con esta URL se puede filtrar por el titulo de la pelicula para obtener toda su 
                        ...
                        <br/>Por ejemplo, con la pelicula "Big Hero 6": 
                        <a class="apilink" href="../api/api.php/getPelicula/Big Hero 6">
                        http://filmdate-filmdate.rhcloud.com/api/api.php/getPelicula/Big Hero 6</a>
                        <!--<a class="apilink" href="http://filmdate-filmdate.rhcloud.com/api/api.php/getPelicula/Big Hero 6">
                    http://filmdate-filmdate.rhcloud.com/api/api.php/getPelicula/Big Hero 6</a>-->
                    </p>
                </div>
                ...
                <div class="ruta"> 
                    ...
                    <p>Con esta URL proporcionamos todas las peliculas que se encuentran en la cartelera de nuestra
                     ...
                     <br/>Por ejemplo: 
                        <a class="apilink" href="../api/api.php/getCartelera">
                        http://filmdate-filmdate.rhcloud.com/api/api.php/getCartelera</a>
                     <!--<a class="apilink" href="http://filmdate-filmdate.rhcloud.com/api/api.php/getCartelera">
                    http://filmdate-filmdate.rhcloud.com/api/api.php/getCartelera</a>-->
                    </p>
                </div>
                ...
                <div class="ruta">
                    ...
                    <br/>Por ejemplo: 
                        <a class="apilink" href="../api/api.php/getProximamente">
                        http://filmdate-filmdate.rhcloud.com/api/api.php/getProximamente</a>
                    <!--<a class="apilink" href="http://filmdate-filmdate.rhcloud.com/api/api.php/getProximamente">
                    http://filmdate-filmdate.rhcloud.com/api/api.php/getProximamente</a> -->
                    </p>
