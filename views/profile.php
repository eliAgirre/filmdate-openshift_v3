	...
	<body>
        ...
        <div id="cont">
            ...
            <div class="page-wrap">
                ...
                <h2 class="pelisquesigues">Comentarios: </h2>
                <!-- Tabla de los comentarios que ha hecho a las peliculas -->
                <table id="pelisComents">                    
                    <?php
                        include("../includes/pelisComents.php");
                    ?>
                </table>
        ...
        <!--Ventana Modal del Editar comentario-->
        <div class="modal fade" id="editComent" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="panel-body">
                                <form name="editarPeli" role="form" method="post" action="../model/editarComent.php" 
                                onSubmit="return revisarEditarPeli();">
                                    <div class="form-group">
                                        <label for="exampleInputComent">Comentario</label>
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-align-left"></span></span>
                                            <input type="hidden" id="id" name="id">
                                            <textarea type="text" id="coment" name="coment" class="form-control" placeholder="Nuevo comentario" maxlength="500" style="height:100px;" required></textarea>
                                        </div>
                                    </div>
                                    <br/>
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true" class="btn btn-success" 
                                    ...
                                    <button type="submit" name="editComent" class="btn btn-primary" style="background:#66cccc;border:none;">
        ...
        </div> <!-- Cierre de la Ventana Modal Editar comentario -->
        <script type="text/javascript">
